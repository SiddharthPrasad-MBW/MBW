...
module "monitoring" {
  ...
  # Monitoring Configuration (dev-specific: more frequent, shorter retention)
  monitoring_schedule = "rate(12 hours)"  # More frequent than prod (24 hours)
  retention_days       = 7                 # Shorter retention than prod (30 days)
  worker_count        = 1                  # Lower than prod (2)
  timeout_minutes     = 3                  # Shorter than prod (5)
